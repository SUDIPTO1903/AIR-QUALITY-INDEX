...
# Apply Intel optimizations to sklearn
patch_sklearn()
...
# ------------------------------
# Logistic Regression (Intel Optimized)
# ------------------------------
...
# Convert the AQI into a binary classification problem for Logistic Regression
# Here, we create a threshold to classify AQI levels into two categories (e.g., good vs bad air quality)
threshold = y_train.median()  # Example threshold (you can adjust it)
y_train_binary = (y_train >= threshold).astype(int)
y_test_binary = (y_test >= threshold).astype(int)

# Initialize Logistic Regression using Intel-optimized version
logistic_model = LogisticRegression(max_iter=1000)
logistic_model.fit(X_train_scaled, y_train_binary)  # Fit the model
...
print('--- Logistic Regression (Intel Optimized) Results ---')
